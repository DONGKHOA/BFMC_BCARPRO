...
void MPU9250_DataConvert(imu_9250_t *mpu9250)
{
	...
	mpu9250->pt1_p.gyro_x = (mpu9250->pt1_p.gyro_x_raw - mpu9250->pt1_p.cal_gyx) / LSB_Sensitivity_GYRO;
	mpu9250->pt1_p.gyro_y = (mpu9250->pt1_p.gyro_y_raw - mpu9250->pt1_p.cal_gyy) / LSB_Sensitivity_GYRO;
	mpu9250->pt1_p.gyro_z = ((mpu9250->pt1_p.gyro_z_raw - mpu9250->pt1_p.cal_gyz) / (LSB_Sensitivity_GYRO) * 6);
}
